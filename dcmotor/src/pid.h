...
SCA_TDF_MODULE(pid){
	...
	sca_tdf::sca_signal<double> diff2p;
	sca_tdf::sca_signal<double> diff2i;
	sca_tdf::sca_signal<double> diff2d;
	sca_tdf::sca_signal<double> p2sum;
	sca_tdf::sca_signal<double> i2sum;
	sca_tdf::sca_signal<double> d2sum;
